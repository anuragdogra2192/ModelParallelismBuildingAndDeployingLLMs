...
export CMD=" \
            python /dli/NeMo/examples/nlp/language_modeling/megatron_gpt_pretraining.py \
            --config-path=/dli/NeMo/examples/nlp/language_modeling/conf/ \
