...
def add_argument():
    ...
    parser.add_argument('--num-experts-per-layer',
                        type=int,
                        default=1,
                        help='number of experts per layer, MoE related.')
    parser.add_argument('--num-expert-layers',
                        type=int,
                        default=1,
                        help='number of expert layers, MoE related.')
    parser.add_argument(
        '--mlp-type',
        type=str,
        default='standard',
...
class Net(nn.Module):
    def __init__(self):
        ...
        if args.moe:
            fc3 = nn.Linear(84, 84)
            self.moe_layer_list = []
            for n_e in range(args.num_expert_layers):
                # create moe layers based on the number of experts
                self.moe_layer_list.append(
                    deepspeed.moe.layer.MoE(
                        hidden_size=84,
                        expert=fc3,
                        num_experts=args.num_experts_per_layer,
