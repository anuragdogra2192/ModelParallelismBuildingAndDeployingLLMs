#!/bin/bash
#SBATCH --job-name=dli_2nodes_hybrid__sol
#SBATCH --nodes=2
...
MICRO_BATCH_SIZE=8     # <--- CHANGED HERE
...
# Data Paths
DATA_OUTPUT_PATH=/dli/nemo/checkpoints/test
CHECKPOINT_PATH=/dli/nemo/checkpoints
TENSORBOARD_PATH=/dli/nemo/tensorboard
...
NAME="log_2Nodes4GPUS_hybrid_solution"       # <--- CHANGED HERE 
